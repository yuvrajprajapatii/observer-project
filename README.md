...
[![Status](https://img.shields.io/badge/Status-Active%20Development-black)](https://github.com/yuvrajprajapatii/observer-project)
...
2. **Intelligence** (Phase 2 - Planned 2026+): AI-driven interest assessment and career recommendations
...
|---|---|---|---|
| **Phase 1** | Active Development | User authentication (email, Google, GitHub) | Sep 2025 - Sep 2026 |
| | | Database infrastructure (MongoDB + Prisma) | |
| | | User profile management | |
| | | Security hardening & testing (in progress) | |
| **Phase 2** | Planned | Interest assessment engine | 2026+ |
...
Detailed contribution guidelines will be published when accepting external PRs (2026+).
